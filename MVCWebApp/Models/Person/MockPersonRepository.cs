...
namespace MVCWebApp.Models.Person
{
    public class MockPersonRepository : IPersonRepository
    {
        ...
        {
            Person p1 = new Person { Name = "Abel Haile", City = "Gothenburg", PhoneNumber = "123456789", ID = GetNewID() };
            Person p2 = new Person { Name = "Billy Walters ", City = "DC", PhoneNumber = "345678904", ID = GetNewID() };
